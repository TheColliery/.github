...
Relationship to the other rule layers: the **Phoenix 13 Commandments** implement principles 6–8 and 10 for hooks; **scripts-quality** implements 2 and 6 for CLI scripts; this file governs the whole series. Each tool re-validates its stamped copies of those layers through the gold-standard lifecycle.
