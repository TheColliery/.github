...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Developers-390%2B%20%2F%2014d-brightgreen?style=for-the-badge" alt="Developers">
...
| :--- | :--- | :--- | :--- |
| **[CoalMine](https://github.com/HetCreep/CoalMine)** | *Extraction* | **Live** ![ver](https://img.shields.io/github/v/tag/HetCreep/CoalMine?sort=semver&label=&color=success&style=flat-square)<br>[![Downloads](https://img.shields.io/badge/CoalMine_Downloads-1.1k%20%2F%2014d-orange?style=flat-square)](https://github.com/HetCreep/CoalMine)<br>[![Developers](https://img.shields.io/badge/CoalMine_Developers-250%20%2F%2014d-brightgreen?style=flat-square)](https://github.com/HetCreep/CoalMine) | Nine quality-**canary** skills (code-health, grounding, supply-chain, resilience, observability, testability, scaling, drift, completeness) that equip agents for raw, safe code extraction. |
| **[CoalTipple](https://github.com/TheColliery/CoalTipple)** | *Sorting* | **Live** ![ver](https://img.shields.io/github/v/tag/TheColliery/CoalTipple?sort=semver&label=&color=success&style=flat-square), early<br>[![Downloads](https://img.shields.io/badge/CoalTipple_Downloads-300%20%2F%2014d-orange?style=flat-square)](https://github.com/TheColliery/CoalTipple)<br>[![Developers](https://img.shields.io/badge/CoalTipple_Developers-140%20%2F%2014d-brightgreen?style=flat-square)](https://github.com/TheColliery/CoalTipple) | A model/effort **router**: **delegation** (down, to save tokens) and **escalation** (up, for quality), a `qualityBar` staircase, and a fail-safe model-ranking **Lock**. Built and validated in real use on Claude Code. |
