...
8. Public docs (README, SECURITY.md, CONTRIBUTING.md, PRIVACY.md, CHANGELOG.md) → [`DOC-PATTERN.md`](./DOC-PATTERN.md) — each has its own section spine (SECURITY.md's 6-row table, CONTRIBUTING.md's 7-row table, PRIVACY.md's fixed shape, CHANGELOG's keep-a-changelog format). Not restated here.
